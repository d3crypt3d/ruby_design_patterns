...
class TestDrive
  ...
  def create_breakfast_menu
    ...
    [['K&B\'s Pancake Breakfast', 
     ...
     ['Waffles',
      ...
      true,
      3.59]].inject(pancake_menu, &method(:menu_creator))
  end
  ...
  def create_diner_menu
    ...
    [['Vegetarian BLT',
     ...
     ['Pasta',
      ...
      true, 
      3.89]].inject(diner_menu, &method(:menu_creator))
    ...
    ['Sorbet',
     ...
     true,
     1.89]].inject(dessert_menu, &method(:menu_creator)) 
  ...
  def create_cafe_menu
    ...
    ['Burrito',
     ...
     true, 
     4.29]].inject(cafe_menu, &method(:menu_creator))
    ...
    [['Coffee Cake',
     ...
     ['Biscotti',
      ...
      true,
      0.89]].inject(coffee_menu, &method(:menu_creator))
